        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                        <div style="color: snow; background-color: #1e7e34; padding: 20px;margin: 0; font-size: 20px;">
                            <strong>Мои финансовые операции:</strong>
                        </div>
                </div>
            </div>
            ...
            @if($n%2==0)
                ...
                <div class="row" style="background-color: #71dd8a">
                    @endif
                    <div class="col-md-2" style="text-align: center">{{$n+=1}} &nbsp;&nbsp;&nbsp;&nbsp; | &nbsp;
                        @if(Auth::id()==$operation->payer->id)
                           Я
                        @else
                            {{$operation->payer->name}} {{$operation->payer->email}}
                        @endif
                    </div>
                    <div class="col-md-2" style="text-align: center">
                        @if(Auth::id()==$operation->receiver->id)
                            Я
                        @else
                            {{$operation->receiver->name}} {{$operation->receiver->email }}
                        @endif
                    </div>
